...
import { PdfBrush, PdfPageArea, IPdfTagContent, IPdfFontFile, IPdfDocumentOptions } from '@grapecity/wijmo.pdf';
...
declare class TrStructCache {
    ...
    readonly el: pdf.IPdfTag;
    getTR(row: number, cellType: _CellType): pdf.IPdfTag;
}
export declare class _CellRenderer {
    ...
    renderCell(value: string, row: _IRow, column: _IColumn, rng: _CellRangeExt, r: Rect): pdf.IPdfTagContent;
    private _renderCell;
